...
. ./whatdevices.sh
time gst-launch-1.0 filesrc location=~/Videos/sintel_trailer-720p.mp4 ! qtdemux ! h264parse ! ${DECODER} !  ${ENCODER} extra-controls="encode,h264_level=10,h264_profile=4,frame_level_rate_control_enable=1,video_bitrate=2097152" ! h264parse ! matroskamux ! filesink location=~/output.mkv
